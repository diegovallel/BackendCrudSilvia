...
if(isset($data->id)){
    ...
    $check_post = "SELECT * FROM `usuarios` WHERE id=:usuario_id";
    $check_post_stmt = $conn->prepare($check_post);
    $check_post_stmt->bindValue(':usuario_id', $usuario_id,PDO::PARAM_INT);
    ...
    if($check_post_stmt->rowCount() > 0){
        ...
        $delete_post = "DELETE FROM `usuarios` WHERE id=:usuario_id";
        $delete_post_stmt = $conn->prepare($delete_post);
        $delete_post_stmt->bindValue(':usuario_id', $usuario_id,PDO::PARAM_INT);
